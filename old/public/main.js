...
clearButton.addEventListener('click', (event) => {
  ...
  //Повторно заносим ингредиенты в список
...
ingredientsList.forEach((ingredient) => {
  ...
  // let selectedIngredientsElements = document.querySelectorAll(".selected");
  // let selectedIngredientsCookie = [];
  // selectedIngredientsElements.forEach((element) => {
  //   const dataId = element.getAttribute("data-id");
  //   selectedIngredientsCookie.push(dataId);
  // });
});
// // Чтение куки с именем "ingredients"
...
//   if (keyValue[0] === 'ingredients') {
//     var ingredients = keyValue[1];
//     // Делайте что-то с полученными ингредиентами
//   }
// }
// const expirationDate = new Date();
// expirationDate.setDate(expirationDate.getDate() + 7); // Устанавливает срок действия куки на 7 дней
// document.cookie =
//   `ingredients=${JSON.stringify(selectedIngredients)}; expires=` +
